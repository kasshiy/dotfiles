...
au ColorScheme * hi CursorLineNr ctermbg=NONE cterm=italic guibg=NONE gui=italic
...
au ColorScheme * hi Visual term=reverse cterm=bold ctermfg=119 ctermbg=241 gui=bold guifg=#30D250 guibg=#3C6514
